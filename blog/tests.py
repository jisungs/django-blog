...
class TestView(TestCase):
    def setUp(self):
        ...
        self.user_jisungs = User.objects.create_user(username='jisungs', password='wltjd6230')
        self.user_jisungs.is_staff = True
        self.user_jisungs.save()
    ...
    def test_update_post(self):
        ...
        # 로그인은 했지만, 작성자가 아닌 경우
        self.assertNotEqual(self.post_003.author, self.user_tony)
        self.client.login(
            username=self.user_tony.username,
            password='wltjd6230'
        )
        response = self.client.get(update_post_url)
